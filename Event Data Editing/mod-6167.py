...
def rebuild_6167_file(json_file, output_file):
    ...
    with open(output_file, 'wb') as f:
        ...
        for entry in entries:
            write_u32(f, entry.get("EntryNumber", 0))
...
def main():
    if len(sys.argv) < 3:
        print("FE3H: 6167")
        print("For file: nx/event/talk_event/data/6167.bin")
        print("")
        print("Usage:")
        print("  To dump:   python mod-6167.py dump <6167.bin> [output.json]")
        print("  To build:  python mod-6167.py build <input.json> [6167.bin]")
        print("")
    ...
    if mode == "dump":
        ...
        try:
            result = parse_6167_file(input_file)
        ...
        try:
            rebuild_6167_file(input_file, output_file)
