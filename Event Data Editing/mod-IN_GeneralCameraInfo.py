...
def rebuild_6159_file(json_file, output_file):
...
def main():
    if len(sys.argv) < 3:
        print("FE3H: IN_GeneralCameraInfo")
        print("For file: romfs/patch4/nx/event/talk_event/data/IN_GeneralCameraInfo.bin")
        print("")
        print("Usage:")
        print("  To dump:   python mod-IN_GeneralCameraInfo.py dump <IN_GeneralCameraInfo.bin> [output.json]")
        print("  To build:  python mod-IN_GeneralCameraInfo.py build <input.json> [IN_GeneralCameraInfo.bin]")
        print("")
    ...
    if mode == "dump":
        ...
        try:
            result = parse_6159_file(input_file)
        ...
        try:
            rebuild_6159_file(input_file, output_file)
