...
To patch info files launch the INFO Patcher in Tools.
The Mods Folder is where you mods are stored, think of it has the romfs folder.
The Original Patch Folder is where the games update files are, all that's really is important is the info files.\ This folder should contain folders call "patch4", "patch3", etc.
...
Source: https://github.com/three-houses-research-team/THAT